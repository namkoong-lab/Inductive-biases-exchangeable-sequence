...
def main():
    ...
    wandb_run_name = f"{model_args.model_type}_X_{model_args.dim_llm_embedding}_Y_{model_args.dim_y}_Horizon_{training_args.train_horizon}_Noise_{data_args.noise_scale}_UQ-{model_args.uncertainty}-Gradient-{model_args.gradient_type}-Loss-{model_args.loss_type}"
    # Initialize wandb
