...
class ExCg_Model(nn.Module):
    ...
    def construct_excg_mask(self, num_ctx, num_tar):
    ...
    def forward(self, batch):
        ...
        mask = self.construct_excg_mask(xc.shape[1], xt.shape[1])
    ...
    def construct_excg_prediction_mask(self, batch):
    ...
    def predict(self, batch):
        ...
        mask = self.construct_excg_prediction_mask(batch)
