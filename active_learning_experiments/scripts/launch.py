...
def main(config_file, main_script, port, gpu_ids):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpu_ids", type=str, default="0", help="Comma-separated GPU IDs (default: 0)")

    args = parser.parse_args()

    main(args.config_file, args.main_script, args.port, args.gpu_ids)